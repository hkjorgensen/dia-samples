...
function onSay(motion) {
  ...
  //Update the graphs
  data.x.push(accelerationIncludingGravity.x);
  ...
  $('#ax').html(accelerationIncludingGravity.x + '<br>high/low: ' + highX + ' / ' + lowX + '<br>mean: ' + meanX);
  $.plot($("#plotax"), [ resX ], options);

  data.y.push(accelerationIncludingGravity.y);
  ...
  $('#ay').html(accelerationIncludingGravity.y + '<br>high/low: ' + highY + ' / ' + lowY + '<br>mean: ' + meanY);
  $.plot($("#plotay"), [ resY ], options);

  data.z.push(accelerationIncludingGravity.z);
  ...
  $('#az').html(accelerationIncludingGravity.z + '<br>high/low: ' + highZ + ' / ' + lowZ + '<br>mean: ' + meanZ);
